...
{
    /// <inheritdoc />
    public partial class initMedCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Allergies_Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChronicConditions_Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_AppointmentId_MedicationId",
                table: "Prescriptions",
                columns: new[] { "AppointmentId", "MedicationId" },
                unique: true);
