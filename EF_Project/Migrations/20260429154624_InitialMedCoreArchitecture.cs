...
{
    /// <inheritdoc />
    public partial class InitialMedCoreArchitecture : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Patients_PatientApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DailyAvailability_Time", "EndTime > StartTime");
                    table.ForeignKey(
                        name: "FK_DailyAvailabilities_DoctorSchedules_DoctorScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicationId = table.Column<int>(type: "int", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyAvailabilities_DoctorScheduleId_Day",
                table: "DailyAvailabilities",
                columns: new[] { "DoctorScheduleId", "Day" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_PatientApplicationUserId",
                table: "Prescriptions",
